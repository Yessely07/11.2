...
export default function PostList() {
  ...
  const sortedPosts = useMemo(() => {
    let sortablePosts = [...posts]; // Copia superficial del estado posts
    if (sortConfig !== null) {
      // Si hay una configuración de ordenación válida
    ...
    return sortablePosts; // Devuelve los posts ordenados
  }, [posts, sortConfig]); // Dependencias para recalcular el valor memorizado
